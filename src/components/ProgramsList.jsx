...
const programs = [
  { id: 'p1', title: 'Career Launchpad', dur: '8 weeks', summary: 'Foundations, projects & mentor support.' },
  { id: 'p2', title: 'Leadership Track', dur: '12 weeks', summary: 'Soft skills, communication and leadership.' },
  { id: 'p3', title: 'Women in Tech', dur: '6 weeks', summary: 'Focused cohort for women entering tech.' }
];
